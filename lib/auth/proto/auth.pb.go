...
func (Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_auth_190fae5adb7efb47, []int{0}
}
...
func (*Watch) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_190fae5adb7efb47, []int{1}
}
...
func (*WatchKind) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_190fae5adb7efb47, []int{2}
}
...
func (*Certs) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_190fae5adb7efb47, []int{3}
}
...
func (*UserCertsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_190fae5adb7efb47, []int{4}
}
...
func (*GetUserRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_190fae5adb7efb47, []int{5}
}
...
func (*GetUsersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_190fae5adb7efb47, []int{6}
}
...
type AccessRequests struct {
	AccessRequests       []*services.AccessRequestV1 `protobuf:"bytes,1,rep,name=AccessRequests" json:"access_requests"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (*AccessRequests) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_190fae5adb7efb47, []int{7}
}
...
func (m *AccessRequests) GetAccessRequests() []*services.AccessRequestV1 {
	if m != nil {
		return m.AccessRequests
	}
	return nil
...
func (*RequestStateSetter) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_190fae5adb7efb47, []int{8}
}
...
func (*RequestID) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_190fae5adb7efb47, []int{9}
}
...
type AuthServiceClient interface {
	...
	// WatchAccessRequests is a variant of WatchEvents which supports custom
	// filtering options specific to access requests.
	WatchAccessRequests(ctx context.Context, in *services.AccessRequestFilter, opts ...grpc.CallOption) (AuthService_WatchAccessRequestsClient, error)
	// CreateAccessRequest creates a new access request.
	CreateAccessRequest(ctx context.Context, in *services.AccessRequestV1, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *authServiceClient) WatchAccessRequests(ctx context.Context, in *services.AccessRequestFilter, opts ...grpc.CallOption) (AuthService_WatchAccessRequestsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AuthService_serviceDesc.Streams[3], "/proto.AuthService/WatchAccessRequests", opts...)
	if err != nil {
		return nil, err
	}
	x := &authServiceWatchAccessRequestsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type AuthService_WatchAccessRequestsClient interface {
	Recv() (*services.AccessRequestV1, error)
	grpc.ClientStream
}

type authServiceWatchAccessRequestsClient struct {
	grpc.ClientStream
}

func (x *authServiceWatchAccessRequestsClient) Recv() (*services.AccessRequestV1, error) {
	m := new(services.AccessRequestV1)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *authServiceClient) CreateAccessRequest(ctx context.Context, in *services.AccessRequestV1, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type AuthServiceServer interface {
	...
	// WatchAccessRequests is a variant of WatchEvents which supports custom
	// filtering options specific to access requests.
	WatchAccessRequests(*services.AccessRequestFilter, AuthService_WatchAccessRequestsServer) error
	// CreateAccessRequest creates a new access request.
	CreateAccessRequest(context.Context, *services.AccessRequestV1) (*empty.Empty, error)
	// DeleteAccessRequest deletes an access request.
...
func _AuthService_WatchAccessRequests_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(services.AccessRequestFilter)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AuthServiceServer).WatchAccessRequests(m, &authServiceWatchAccessRequestsServer{stream})
}

type AuthService_WatchAccessRequestsServer interface {
	Send(*services.AccessRequestV1) error
	grpc.ServerStream
}

type authServiceWatchAccessRequestsServer struct {
	grpc.ServerStream
}

func (x *authServiceWatchAccessRequestsServer) Send(m *services.AccessRequestV1) error {
	return x.ServerStream.SendMsg(m)
}
...
func _AuthService_CreateAccessRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(services.AccessRequestV1)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).CreateAccessRequest(ctx, req.(*services.AccessRequestV1))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "WatchAccessRequests",
			Handler:       _AuthService_WatchAccessRequests_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "auth.proto",
...
func (m *AccessRequests) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.AccessRequests = append(m.AccessRequests, &services.AccessRequestV1{})
...
func init() { proto.RegisterFile("auth.proto", fileDescriptor_auth_190fae5adb7efb47) }

var fileDescriptor_auth_190fae5adb7efb47 = []byte{
	...
	,
}
